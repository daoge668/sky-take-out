...
//        checkOutOfRange(addressBook.getCityName()+ addressBook.getDistrictName()+ addressBook.getDetail());
    ...
    public PageResult pageQuery4User(int page, int pageSize, Integer status) {
        ...
        OrdersPageQueryDTO ordersPageQueryDTO = OrdersPageQueryDTO.builder()
                ...
                .status(status)
                .build();
        Page<Orders> pageInfo = (Page<Orders>) orderMapper.pageQueryUser(ordersPageQueryDTO);
        List<OrderVO> orderVOList = new ArrayList<>();
        if (pageInfo.getResult() != null && !pageInfo.getResult().isEmpty()){
            for (Orders orders : pageInfo.getResult()) {
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        ...
        Orders orders = Orders.builder()
                .id(ordersDB.getId())
                .status(Orders.CANCELLED) // 状态：3-拒单
    ...
    public void reminder(Long id) {
        ...
        webSocketServer.sendToAllClient(JSONUtils.toJSONString(map));
    }
